...
class Player {
    ...
    constructor(root) {
        ...
        this.domElement.src = "images/spaceShip2.png";
        ...
        // root.appendChild(this.beam);
        // this.beam.style.position = "absolute";
        // this.beam.style.visibility = "hidden"
    ...
    moveLeft() {
        ...
        this.domElement.style.left = `${this.x}px`;//`${this.x}px`
    ...
    spaceBar() {
    let shoot = new Beams(this.x,this.y)
