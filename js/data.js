...
const GAME_WIDTH = 1800; //500
const GAME_HEIGHT = 1300; //700
...
const ENEMY_WIDTH = 190; //75
const ENEMY_HEIGHT = 100; //156
const MAX_ENEMIES = 5;

// These constants represent the player width and height.
const PLAYER_WIDTH = 190;//75
const PLAYER_HEIGHT = 100; //54
